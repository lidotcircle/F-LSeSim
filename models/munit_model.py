...
class MUNITModel(BaseModel):
    ...
    def backward_G(self):
        ...
        gen_losses['cycle_recon'] = \
            self.criterionCycle(self.G_output['images_aba'], self.data['images_a']) + \
            self.criterionCycle(self.G_output['images_bab'], self.data['images_b'])
    ...
    def compute_visuals(self):
        ...
        if hasattr(self, 'netD'):
            ...
            self.val_loss_G_B = self.criterionGAN(net_D_output['out_ab'], True)
            self.val_loss_D_B_real = self.criterionGAN(net_D_output['out_b'], True)
            self.val_loss_D_B_fake = self.criterionGAN(net_D_output['out_ab'], False)