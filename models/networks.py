...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    if netG == 'resnet_9blocks':
        ...
        net = ResnetPreAE(input_nc, output_nc, ngf, n_blocks=opt.g_num_layers, attn_mode=opt.attn_mode, interp_mode=opt.interp_mode, merge_mode=opt.merge_mode, only_focus=opt.only_focus)
    elif netG == 'stylegan2':
