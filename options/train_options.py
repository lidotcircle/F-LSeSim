...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--total_iters', type=int, default=0, help='total iterations, override n_epochs + n_epochs_decay')
        ...
        parser.add_argument('--gen_lr_multiplier', type=float, default=1, help='generator learning rate multiplier')

        parser.add_argument('--projgan_resnet18', type=str, default=None, help='projgan_resnet18_pretrained')
        ...
        parser.add_argument('--param_stats', action='store_true', help='calculate parameter statistics')
